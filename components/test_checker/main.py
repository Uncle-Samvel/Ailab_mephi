...
from components.test_checker.database import DbGeneratorTest
from components.test_checker.database.serialaze import *
...
if __name__ == '__main__':
    db = DbGeneratorTest(user="user", password="pass", host="localhost", port=5555, database="database2")
